...
<body>
    ...
    <section class="product">
        <h1><span>Best</span> Selling Product</h1>
                ...
                if(mysqli_num_rows($select_products)>0){
                    while($fetch_product=mysqli_fetch_array($select_products)){
                        ...
                        <div class="content">
                            ...
                            <a href="product.php?id=<?php echo ($fetch_product['product_id']);?>" target="_blank"><button class="cart_btn">Add To Cart</button></a> <!--Insert profile per product path-->
                        </div>
                    <?php
                    }
                }
