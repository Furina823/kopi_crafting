...
<head>
    ...
    <script type='text/javascript'>
        function checkAlert(id){
            ...
            if(message){
                window.location.href= `delete_order_staff.php?del=${id}`;
            }
        }
        ...
        function checkStatus(id){
            ...
            if(message){
                window.location.href= `update_order_staff.php?id=${id}`;
            }
        }
...
<body>
    ...
    <div class="order_list">
        <div class="filter">
            ...
            <br><br>
            <a href="order_staff.php?order_status=all">All</a>
            <a href="order_staff.php?order_status=to_ship">TO SHIP</a>    
            <a href="order_staff.php?order_status=shipping">SHIPPING</a>
            <a href="order_staff.php?order_status=delivered">DELIVERED</a>
            <a href="order_staff.php?order_status=reviewed">REVIEWED</a>
        </div>  
        <div class="order">
