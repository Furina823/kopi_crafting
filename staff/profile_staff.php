...
if (isset($_SESSION['email'])) {
    ...
    $sql ="SELECT * FROM staffs WHERE staff_email = ?";
    ...
    if($result-> num_rows > 0){
        ...
        $staff_phone = $row['staff_phone_number'];
        $staff_address = $row['staff_address'];
        $staff_status = $row['staff_status'];
    }

} else {
    // Handle case where session variable 'email' is not set
    ...
    <div class="profile">
        <div class="profile_head"> 
            <div class="name_title">
                <p>Username: <?php echo $staff_name;?></p>
                <p>Title: <?php echo $staff_status;?></p>
            </div>
            <div class="title">
